...
public class MainActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alarmList = PersistanceService.loadList(baseContext, PersistanceKeys.ALARM_LIST, Alarm.class);
    ...
    private void initAlarmList() {
        ...
        gridViewAdapter = new GridViewAdapter(getApplicationContext(), R.layout.alarm_list_item, alarmList);
    ...
    public void onItemClick(final AdapterView<?> arg0, final View view, final int position, final long id) {
        String message = "Clicked : " + alarmList.get(position).getFormattedTime();
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(MainActivity.this, R.style.AppTheme_Dialog, new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        ...
                        alarmList.add(new Alarm(selectedHour, selectedMinute, true));
                        PersistanceService.saveList(getBaseContext(), PersistanceKeys.ALARM_LIST, alarmList);
